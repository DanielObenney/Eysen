...
form.addEventListener('submit', (e) => {
    ...
    if(firstname_input){
        ...
        errors = getLoginFormErrors(phone_input.value, email_input.value, password_input.value)
    }    
...
function getLoginFormErrors(phone, email, password){
    let errors = []
...
const allInputs = [firstname_input, phone_input, email_input, password_input, repeat_password_input].filter(input => input != null)
